...
Fast, trustworthy, minimal. The voice is direct and peer-built rather than institutional, promotional, or overly technical.

## Anti-references

Do not imitate Chandigarh University branding or present the extension as university-endorsed. Avoid institutional marketing, generic AI-generated dashboard styling, startup gradients, glass effects, oversized cards, decorative copy, and playful treatment of credentials or privacy.
...
- Keep every permission, setting, and interface element necessary and explainable.

## Accessibility & Inclusion

Target WCAG AA contrast and keyboard usability. Respect reduced-motion preferences. Do not rely on color alone for meaning. Use readable default text sizing and native form semantics.
